              ...
              <ul className="list-unstyled example-components-list">
                ...
                <li>
                  <NavLink to="/javascript/collapse">Collapse <Fa icon="angle-right" /></NavLink>
                                ...
                                <li>
                  <NavLink to="/javascript/carousel">Image Sliders With Masks and/or Title<Fa icon="angle-right" /></NavLink>
                </li>
                                                <li>
                  <NavLink to="/javascript/videocarousel">Video Sliders <Fa icon="angle-right" /></NavLink>
                </li>
              </ul>
            </Jumbotron>
          </Col>
