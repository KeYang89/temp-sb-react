 ...
 * https://sbec.com/
 *
 * Read the license: https://sbec.com/license/
 *
 *
 * Documentation: https://sbec.com/
 *
 * Getting started: https://sbec.com/getting-started/
 *
 * Tutorials: https://sbec.com/bootstrap-tutorial/
 *
 * Templates: https://sbec.com/templates/
 *
 * Support: https://sbec.com/support/
 *
 * Contact: office@sbec.com
 *
...
.show > .modal-dialog.modal-notify.modal-danger .btn-outline-secondary-modal.dropdown-toggle:focus, ul.instagram-photos li img, .media .media-left img {
